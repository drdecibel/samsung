...
metadata {
    definition (name: "ZigBee White Color Temperature Bulb", namespace: "smartthings", author: "SmartThings") {
		...
		fingerprint profileId: "0104", inClusters: "0000, 0004, 0003, 0006, 0008, 0005, FFFF", outClusters: "0019, 0406, 000A", manufacturer: "LEEDARSON LIGHTING", model: "A470S-A7R", deviceJoinName: "Home Control LED"
